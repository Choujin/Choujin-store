...
?>
                ...
                <div class="col-md-9">      <!-- col-md-9 Begin -->
                    <div id="productMain" class="row">      <!-- row Begin -->
                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">        <!-- carousel slide Begin -->
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <center><img class="img-responsive" src="admin_area/product_images/product-1a.jpg" alt="Product 1-a"></center>
                                        </div>
                                        <div class="item">
                                            <center><img class="img-responsive" src="admin_area/product_images/product-1b.jpg" alt="Product 1-b"></center>
                                        </div>
                                        <div class="item">
                                            <center><img class="img-responsive" src="admin_area/product_images/product-1c.jpg" alt="Product 1-c"></center>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-6">      <!-- col-sm-6 Begin -->
                            <div class="box">        <!-- box Begin -->
                                <h1 class="text-center">Black Knight T-Shirt</h1>
                            ...
                            <div class="row" id="thumbs">        <!-- row Begin -->
                                ...
                                <img src="admin_area/product_images/product-1b.jpg" alt="product 1" class="img-responsive">      
                                </a>        <!-- thumb Finish -->
                                </div>       <!-- col-xs-4 Finish -->

                                <div class="col-xs-4">      <!-- col-xs-4 Begin -->
                                <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb">       <!-- thumb Begin -->
                                <img src="admin_area/product_images/product-1c.jpg" alt="product 1" class="img-responsive">      
                                </a>        <!-- thumb Finish -->
                                </div>       <!-- col-xs-4 Finish -->
                    ...
                    <div class="box" id="details">       <!-- box Finish -->

                    <h4>Product Details</h4>

                    <p>

                    Fortnite Black Knight T-Shirt American Flag
                        ...
                        <div class="col-md-3 col-sm-6 center-responsive">       <!-- col-md-3 col-sm-6 center-responsive Begin -->
                            <div class="product same-height">       <!-- product same-height Begin -->
                                ...
                                <div class="text">      <!-- text Begin -->
                                    <h3><a href="details.php">One Piece Quotes Giant Wall Art</a></h3>
